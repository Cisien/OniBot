...
namespace OniBot
{
    public class AzureRestVoiceService : IVoiceService
    {
        ...
        private const string SpeechTemplate = "<speak version='1.0' xmlns='http://www.w3.org/2001/10/synthesis' xmlns:mstts='https://www.w3.org/2001/mstts' xml:lang='en-US'><voice xml:lang='en-GB' xml:gender='Female' name='en-GB-HazelRUS'>{0}</voice></speak>";
