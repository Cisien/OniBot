...
namespace OniBot.Infrastructure
{
    class ConfigurationPreconditionAttribute : PreconditionAttribute
    {
        ...
        {
            var logger = services.GetService<ILogger<ConfigurationPreconditionAttribute>>();
